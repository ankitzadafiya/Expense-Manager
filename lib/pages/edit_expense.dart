...
class _EditExpenseState extends State<EditExpense> {
  ...
  void initState() {
    ...
    _formData = {
      ...
      "invoiceURl":widget.expense.invoiceURl,
    ...
    return Container(
      ...
      child: MaterialButton(
        onPressed: () async {
          ...
          if(_formData["invoiceURl"] =="" && imageUrl=="")
          {
            _formData["invoiceURl"]="";
          }
          else if(_formData["invoiceURl"] =="" && imageUrl!="")
          {
            _formData["invoiceURl"]=imageUrl;
          }
          else if(_formData["invoiceURl"] !="" && imageUrl=="")
          {
            _formData["invoiceURl"]=_formData["invoiceURl"];
          }
          else if(_formData["invoiceURl"] !="" && imageUrl!="")
          {
            _formData["invoiceURl"]=imageUrl;
